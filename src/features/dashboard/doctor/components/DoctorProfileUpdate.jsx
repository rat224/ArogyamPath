        ...
        <div className="flex flex-col md:flex-row items-center gap-10 mb-12">
          <div className="relative group">
            <div className={`
              ...
              ${errors.photo ? 'border-red-500' : 'border-blue-50'}
            `}>
              {preview ? (
            ...
            <label className="absolute -bottom-2 -right-2 p-3 rounded-2xl text-white cursor-pointer shadow-lg hover:scale-110 transition-transform bg-blue-600">
              <Camera size={20} />
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2 pt-6">
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 rounded-2xl font-black text-lg shadow-xl transition-all active:scale-[0.98] bg-blue-600 text-white shadow-blue-100 hover:bg-blue-700"
            >
